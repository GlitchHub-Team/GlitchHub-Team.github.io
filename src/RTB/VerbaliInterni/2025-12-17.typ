...
In seguito alla creazione degli *#gloss[Issue Form]* e delle automazioni per le #gloss[GitHub Issues] (#issue_full(104)), il gruppo si è allineato sul nuovo workflow da utilizzare per la creazione delle Issues.
...
Se un membro realizza che una issue è ridondante, allora è tenuto a contrassegnarla come "duplicato" e di chiuderla, comunicando #gloss[ci]ò al resto del gruppo.

Questo cambiamento di workflow verrà rispecchiato nelle #gloss[Norme di Progetto].

== Discussione sprint venturo e milestone interna 31/12/2025
Il gruppo ha discusso sull'organizzazione del prossimo periodo di lavoro. Dato il rallentamento delle attività causato delle feste natalizie (dal 24 al 26 dicembre), si è deciso che lo *#gloss[Sprint] 6* debba durare due settimane, ovvero dal *18 dicembre 2025 al 31 dicembre 2025* inclusi.

Quindi il gruppo ha fissato al *31 dicembre 2025* una #gloss[milestone] interna entro la quale il gruppo si impegna a raggiungere una versione stabile dell'*#gloss[Analisi dei Requisiti]* e del *#gloss[Piano di Qualifica]*, in modo tale da avanzare lo stato dei lavori abbastanza da poterne permettere un rallentamento sostanziale durante la sessione invernale di studi (*19 gennaio 2026 - 21 febbraio 2026*).

== Assegnazione delle prossime task basate sulle decisioni prese
In vista della #gloss[milestone] interna pre-sessione, il gruppo ha deciso di dividersi in due sottogruppi: uno per la redazione del *#gloss[Piano di Qualifica]* e l'altro per la redazione dell'*#gloss[Analisi dei Requisiti]*, rilevando delle sotto-attività atomiche per ciascun documento.

Il gruppo per il *#gloss[Piano di Qualifica]* è composto da Michele Dioli, Hossam Ezzemouri e Siria Salvalaio e le sotto-attività assegnate sono le seguenti:
#table(
  columns: (4fr, 1fr),
...
Il gruppo per l'*#gloss[Analisi dei Requisiti]* è composto da Jaume Bernardi, Alessandro Dinato, Riccardo Graziani, Elia Ernesto Stellin e le sotto-attività assegnate a loro sono le seguenti:
#table(
  columns: (4fr, 2fr, 1fr),
  align: center + horizon,
  ...
  [Definire use cases con simulatore #gloss[Gateway] come #gloss[sistema]], [Alessandro Dinato, Riccardo Graziani], [#issue(125)],

  [Definire use cases sensore-#gloss[gateway]], [Jaume Bernardi, Elia Ernesto Stellin], [#issue(126)],

  [Scrittura dei requisiti e relativi Test di #gloss[Sistema] (nel PdQ)],
