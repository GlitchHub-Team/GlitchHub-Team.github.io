...
#table(
  ...
  [Studio #gloss[NATS], inizio POC], [Alessandro Dinato], [#issue(165)],

  [Stesura dei requisiti e scrittura diagrammi degli #gloss[Use Case]], [Michele Dioli, Jaume Bernardi, Hossam Ezzemouri], [#issue(166)],

  [Sistemare e completare #gloss[Piano di Progetto]], [Elia Ernesto Stellin], [#issue(140)],

  [Aggiungere termini al glossario], [Elia Ernesto Stellin], [#issue(108)],

  [Completare gli #gloss[Use Case] suggeriti da M31], [Elia Ernesto Stellin], [#issue(167)],

  [Studio #gloss[Angular.js]], [Michele Dioli], [#issue(169)],
