...
- *Pre-condizioni*: descrizione delle condizioni che devono essere vere affinché l'attore possa avviare il caso d'uso;
...
#table(
  ...
  [Sensore simulato],
  [Un qualunque sensore BLE che venga simulato dal Simulatore di Gateway sviluppato],
