...
La proponente M31 ha espresso una complessiva soddisfazione per i risultati raggiunti dal gruppo, definendo quanto mostrato un "buon lavoro" e confermando la solidità del percorso intrapreso.
...
M31 ha fornito un feedback tecnico riguardante una preoccupazione del gruppo per la permanenza dei dati: prima di riscontrare reali problemi di performance con PostgreSQL, è necessaria una mole di informazioni estremamente elevata; il sistema rimane dunque scalabile ed efficiente finché non si applicano operazioni di join senza *sharding*.
