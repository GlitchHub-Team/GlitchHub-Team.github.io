...
## Riavvio gateway
Il riavvio di un gateway simulato richiede l'invio di un comando al subject NATS `commands.rebootgateway` e comporta le seguenti azioni:
- Re-invio del **messaggio di Hello**{{gloss}} per la condivisione della **public key** del gateway simulato.
