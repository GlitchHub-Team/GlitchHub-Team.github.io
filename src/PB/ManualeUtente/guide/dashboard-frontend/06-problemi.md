...
In presenza di errori restituiti dalle **#gloss("API")** (es. permessi insufficienti, timeout del server o parametri non validi), l'applicazione mostra un banner rosso nella parte superiore dell'area di lavoro.
...
Nella parte superiore dei grafici in tempo reale viene visualizzato lo stato della connessione **#gloss("websocket")**:
