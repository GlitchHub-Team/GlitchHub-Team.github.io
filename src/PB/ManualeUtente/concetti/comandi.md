...
I gateway possono essere riavviati solo dagli utenti con ruolo di **Super Admin**, o **Tenant Admin** se il gateway è commissionato verso il loro tenant.
...
I gateway possono essere resettati solo dagli utenti con ruolo di **Super Admin**, o **Tenant Admin** se il gateway è commissionato verso il loro tenant.
...
I gateway possono essere interrotti solo dagli utenti con ruolo di **Super Admin**, o **Tenant Admin** se il gateway è commissionato verso il loro tenant e solo se il gateway è in stato Active{{gloss}}.
...
I gateway possono essere ripresi solo dagli utenti con ruolo di **Super Admin**, o **Tenant Admin** se il gateway è commissionato verso il loro tenant e solo se il gateway è in stato Inactive{{gloss}}.
...
Quest'ultima misura è necessaria per garantire che il JWT{{gloss}} possa essere utilizzato solo e soltanto dal gateway simulato per cui è stato generato, evitando così che un JWT generato per un gateway possa essere utilizzato da un altro client.

All'interno del microservizio **Gateway**, il gateway simulato si salverà il **tenantId** e il **token di commissioning**. Successivamente verrà messo in stato Active{{gloss}} e inizierà a pubblicare dal proprio buffer interno verso il message broker NATS JetStream{{gloss}} sul subject{{gloss}} del **tenantId** specificato.
...
I sensori possono essere interrotti solo dagli utenti con ruolo di **Super Admin**, o **Tenant Admin** se il gateway a cui è associato il sensore è commissionato verso il loro tenant, e solo se il sensore è in stato Active{{gloss}}.
