# Gateway
Il microservizio **Gateway** ha lo scopo di gestire più gateway e sensori simulati, fungendo da punto di ingresso per i comandi per questi ultimi e da punto di uscita per i dati prodotti dai sensori.   
...
- Creazione ed eliminazione di gateway e sensori simulati.
