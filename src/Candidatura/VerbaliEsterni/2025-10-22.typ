...
#show: report.with(
  ...
  versione: "1.0.0",
  registro-modifiche: (
    ("1.0.0", "23/10/2025", "Siria Salvalaio", "-", "Verbale riunione con Miriade"),
  ),
...
L'incontro è stato presenziato dai rappresentanti *Alessandro Dinato* e *Siria Salvalaio* in videoconferenza sulla piattaforma _Google Meet_.
...
Miriade ha chiarito che, pur non prevedendo tutoraggio diretto, mette a disposizione dei corsi specifici e supporto tecnico in caso di necessità. \
...
Miriade ha risposto che, sebbene le funzionalità siano centrali, l’applicazione deve essere usabile e *intuitiva* per l’utente finale affinché non appesantisca ulteriormente la posizione dell'utente. \
...
Il gruppo ha chiesto quale grado di accuratezza fosse richiesto per le analisi di intelligenza artificiale e se fosse necessario addestrare veri modelli di *Machine Learning*. \
Miriade ha indicato che l’obiettivo è ottenere risultati il più possibile accurati, ma che è preferibile utilizzare *API o modelli già disponibili*, soprattutto per la parte conversazionale. \
Inoltre, è stato specificato che, qualora la risposta generata non fosse sufficientemente accurata, sarebbe meglio che il sistema non rispondesse affatto.
...
L’azienda ha inoltre precisato di disporre di *legal specialist* che si occupano della conformità alle normative sulla privacy.

== Architettura e supporto AWS
Il gruppo ha richiesto chiarimenti sull’architettura *serverless* proposta nella bozza e sul livello di supporto previsto per la configurazione dei servizi *AWS*. \
Miriade ha confermato la disponibilità a fornire assistenza e indicazioni operative, ma non un affiancamento passo-passo, incoraggiando comunque l’autonomia dei membri del gruppo nello studio della piattaforma.
